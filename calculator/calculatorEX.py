...
class Calculator:
    def __init__(self, master):
        ...
        self.b1 =  self.createButton(7)
        self.b2 = self.createButton(8)
        self.b3 = self.createButton(9)
        self.b4 = self.createButton(u"\u232B",None)
        self.b5 = self.createButton(4)
        self.b6 = self.createButton(5)
        self.b7 = self.createButton(6)
        self.b8 = self.createButton(u"\u00F7")
        self.b9 = self.createButton(1)
        self.b10 = self.createButton(2)
        self.b11 = self.createButton(3)
        self.b12 = self.createButton('*')
        self.b13 = self.createButton('.')
        self.b14 = self.createButton(0)
        self.b15 = self.createButton('+')
        self.b16 = self.createButton('-')
        self.b17 = self.createButton('=',None,34)

        # buttons stored in list
        buttons = [self.b1, self.b2, self.b3,self.b4,self.b5,self.b6,self.b7,self.b8,self.b9,self.b10,self.b11,self.b12,self.b13,self.b14,self.b15,self.b16,self.b17]
